...
import com.mushroomboozehound.Chess_Game.gui.Table.MoveLog;
...
public class GameHistoryPanel extends JPanel {
    ...
    private static class DataModel extends DefaultTableModel {
        ...
        @Override public Class<?> getColumnClass(final int col) { return Move.class; }
        @Override public String getColumnName(final int col) { return NAMES[col]; }
    }
}
