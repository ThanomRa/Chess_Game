...
import com.mushroomboozehound.Chess_Game.engine.classic.pieces.*;
import com.mushroomboozehound.Chess_Game.engine.classic.player.BlackPlayer;
import com.mushroomboozehound.Chess_Game.engine.classic.player.Player;
import com.mushroomboozehound.Chess_Game.engine.classic.player.WhitePlayer;
...
public class Board {
    ...
    public Piece getPiece(final int coordinate) {return this.boardConfig.get(coordinate); }
    public Pawn getEnPassantPawn(){ return this.enPassantPawn; }
    public Move getTransitionMove(){ return this.transitionMove; }
    public static Board createStandardBoard() { return STANDARD_BOARD; }
    ...
    private static Collection<Piece> calculateActivePieces(final Builder builder,
        ...
        return builder.boardConfig.values().stream().filter(piece -> piece.getPieceAllegiance() ==alliance)
