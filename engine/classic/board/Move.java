...
import com.mushroomboozehound.Chess_Game.engine.classic.pieces.Pawn;
...
public abstract class Move {
    ...
    public static class PawnMove extends Move {
        ...
        @Override
        public String toString() { return BoardUtils.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);}
    }
    ...
    static abstract class CastleMove extends Move {
        ...
        public Board execute() {
            ...
            for (final Piece piece : this.board.getAllPieces()) {
             ...
             builder.setPiece(this.movedPiece.movePiece(this));
            //calling movePiece doesn't work here, need to explicitly create a new Rook
    ...
    private static class NullMove extends Move {
        ...
        @Override
        public Board execute() { throw new RuntimeException("Can not execute null move!");}
        @Override
